...
export const PlaceGallery = ({ place }) => {
  ...
  if (showAllPhotos) {
    return (
      <div>
        <ShowAllPhoto place={place} setShowAllPhotos={setShowAllPhotos} />
      </div>
    );
  }
...
const ShowAllPhoto = ({ place, setShowAllPhotos }) => {
  return (
      ...
      <div className="p-8 grid gap-4 bg-black">
        <div>
          ...
          <button
            ...
            className="fixed right-8 top-8 flex gap-2 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
